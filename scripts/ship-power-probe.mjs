...
try{
 ...
 const result=await page.evaluate(async()=>{
  ...
  s.playership=326;B.applyCurrentShipStats(true);B.applyShipDefaultWeapons(326,false);s.power.dist={sensors:0,engines:5,weapons:5,shields:5};
  ...
  const damageBefore=B.getScaledWeaponDamage(n.shipId,weapon,null,1,n);s.power.dist={sensors:0,engines:0,weapons:10,shields:10};
  ...
  s.power.dist={sensors:0,engines:5,weapons:5,shields:5};
  ...
  s.power.dist={sensors:0,engines:5,weapons:10,shields:5};
  ...
  s.power.dist={sensors:0,engines:5,weapons:5,shields:5};n.power.dist={...s.power.dist};
  ...
  n.power.energy=s.power.energy=70;n.power.dist={sensors:0,engines:5,weapons:5,shields:5};n.power.decisionIn=3;
  n.destination={x:n.x,y:n.y};s.ship.velocity=0;s.docked=true;s.power.dist={sensors:0,engines:5,weapons:5,shields:5};
  ...
  s.power.dist={sensors:0,engines:0,weapons:5,shields:5};B.tick(1);const stopped=s.ship.velocity;
  s.power.dist={sensors:0,engines:5,weapons:5,shields:5};B.tick(1);B.keys.clear();
  ...
  s.playerFleet=[{id:'power-fleet',shipId:326,faction:'terran',seed:415,assignment:'escort',name:'Power test escort',crewSkill:'elite',crewTemperament:'reckless',power:{energy:7,dist:{sensors:0,engines:4,weapons:4,shields:4}}}];
  ...
  s.power.energy=9;s.power.dist={sensors:0,engines:4,weapons:4,shields:4};B.saveGame(7);
  ...
  const saved=B.sanitizeSecurityEncountersRecord({version:1,systems:{[home]:{participants:{v999:{npcId:'p',shipId:326,seed:99,x:100,y:100,crewSkill:'elite',crewTemperament:'cautious',power:{energy:2,dist:{sensors:0,engines:3,weapons:3,shields:4}}}}}}});
  ...
  test('OPS has four functional sliders and a read-only unused-allocation count',!html.includes('data-power-tank="reserve"')&&(html.match(/data-power-tank=/g)||[]).length===4&&html.includes('data-power-unused'));
  s.power.dist={sensors:0,engines:5,weapons:5,shields:5};B.setPowerDist('engines',8);
  ...
  test('a full allocation budget redistributes without exceeding twenty points',s.power.dist.weapons===10&&s.power.dist.engines+s.power.dist.weapons+s.power.dist.shields+s.power.dist.sensors===20);
  B.setPowerDist('engines',0);B.setPowerDist('weapons',0);B.setPowerDist('shields',0); B.setPowerDist('sensors',0);
