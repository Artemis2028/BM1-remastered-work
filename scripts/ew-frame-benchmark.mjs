  ...
  payload.gc = {
    ...
    note: gcPlacement === 'none'
      ...
      : gcPlacement === 'between-blocks'
        ? 'diagnostics hygiene: expose-gc; gc() after warmup and after the measured loop; never inside the measured window'
        : 'diagnostics suppression: expose-gc; gc() inside the measured loop between samples; not the gate'
  };
