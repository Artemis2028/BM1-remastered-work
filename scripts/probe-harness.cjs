...
const EXPORT_NAMES = 'state,startWithFaction,advanceFleetCalendar,fleetBook,Fleet,Campaign,campaign,campaignBook,buildCampaignWorld,openCampaignPanel,closeCampaignPanel,renderCampaignPanel,applyDebugCommand,saveGame,loadGame,getSystemControl,spawnFleetAttack,updateSystemActivity,getSystemActivity,launchBudgetedAmbientRaid,destroyStation,getStationOwner,ensurePlaytestState,advanceFactionReconstruction,applySystemState,tick,updateFleetAttacks,getShipyardStock,getStationWeaponStock,fleetStationServices,getSystemFaction,transferSystemControlToPlayer,transferSystemControlToFaction,campaignIntegrationOffers,fleetPlanStatus,buyFleetPlan,commissionStatus,commissionShip,fleetShipStock,getCurrentServiceStation,openRemoteStationShop,gameNow,pauseGameClock,resumeGameClock,ensureCombatTargetStats,getShipStats,changeDiplomacy,captureWorldEncounter,restoreWorldEncounter,maybeMaterializeCampaignOperation,dispatchFleetFormation,isSystemRelayConnected,campaignRelayCoverage,advanceCommissions,getShipPrice,setCamera,renderPlanetMenu,renderFleetManager,getAllWormholeLinks,triggerDebugEvent,getUnfilteredShipyardStock,startDesignRecovery,advanceRecoveryMissions,getStationCapabilities,getFactionStanding,adjustFactionStanding,galaxyNewsBook,visibleGalaxyReports,isChartSystemVisible,reconstructionFunds,syncPlayerPolity,offerStationMission,advanceStationMissions,keys,heldWeaponInputs,updateStats,getPlayerFleetShips,completeFleetJourneys,markSystemVisited,lastSeenDay,collectRegionalIntel,acknowledgeCampaignOrders,getStationEffectiveOffers,deliverFleetBuild,orderFleetBuild,chooseActivityAttacker,areFactionsOpposed,worldRelation,getSystemIndexByName,placePlayerAtSecurityApproach,updateSecurityOrderPanel,getSecurityZone,playerWorldPosition,getShipPurchaseStatus,fleetReservations,openDebugMenu,closePlanetMenu,openPlanetMenu,hasWorldCargoToDeliver,sellOrdinaryCargo,deliverContractCargo,tradeAtPlanet,recalcCargoFromPods,getCurrentDockedStation,autoAssignFleet,updateRecoveryPanel,applyPlayerDamage,applyCurrentShipStats,ensureSystemState,campaignSystemName,campaignMaskText,compatibleRecoveryYard,getNpcCombatDurability,commodityTradeBlock,currentMarketOffers,buyMarketGood,sellMarketGood,getStationPlanStockContext,fleetBuildStationStatus,campaignOperationKnowledge,campaignKnownOperations,addGalaxyReport,isPersonalGalaxyReport,applyCampaignEffects,stationConditionFraction,triggerCampaignDebug,getPlayerFlag,isGeneralProductionDesign,campaignRaidForce,formatFaction,fleetLocalActor,collectRegionalIntel,campaignIntelSource,advanceCampaign,getShipFaction,getCampaignDiscoveries,campaignAssessment,campaignFactionKeyFor,intelIdentityCandidates,campaignPowerContact,campaignObservedWorlds,getNpcShipIdForFaction,getSystemCulture,getTradeStandingFaction,formatCulture,isOwnHoldingVendor,WORLD_CULTURES,WORLD_UNPEOPLED,WORLD_ALLEGIANCE,WORLD_INDEPENDENT,WORLD_FOREIGN_STOCK,getBaseSystemOrigin,getFactionAttitude,getEffectiveAttitude,WITHDRAWN_MISSION_KINDS,migrateWithdrawnMissions,campaignBook,getSaveSlotRaw,getSaveSlotKey,saveGame,loadGame,advanceCampaign,advanceStationMissions,SAVE_SLOT_PREFIX,isRecognizedFactionKey,BM1_GOVERNMENT_FACTIONS,offerStationMission,commodityTradeBlock,getCurrentServiceStation,fleetPlanStatus,ensurePlaytestState,getAlertStatus,updateStats,negotiateContract,getSystemSovereignty,getMapSystemInfo,diplomaticPairs,advanceWorldDiplomacy,isDominionCoreSystem,diplomacyBook,isChartSystemVisible,getSecurityZone,PLAYER_SIDE,getStationOwner,getShipyardStockContext,buyFleetPlan,renderFleetManager,layoutSecurityOrderPanel,securityOrderPanelEl,World,renderTopLeftPanel,openContractsPanel,renderContractsPanel,mapObjectives,mapOverlayState,toggleMapOverlay,MAP_OVERLAY_LAYERS,systemConditions,laneConditions,conditionsFor,conditionsReadout,trueTradeTraffic,trueProtection,trueThreat,trueDisruption,peekSystemActivity,campaignIntelSource,galaxyNewsBook,hasOrbitalAuthority,CONDITION_SOURCES,openMap,closeMap,renderPowerPanel,renderEWPanel,renderSensorPanelMarkup,cycleAlertLevel,alertOverrideReason,openTopLeftTab,getEWUpgradeDecision,getSensorUpgradeDecision,getHojPurchaseDecision,fleetServiceAllowed,EW_MODULES,SENSOR_SUITES,HOJ_WEAPON_ID,getWeapon,vendorStanding,vendorRefusal,serviceRefusal,getShipPurchaseSummary,buyEWModule,buySensorSuite,repairFleetVessel,refitFleetWeapon,getStationWeaponStock,sensorEntity,ensureActorEW,ensureActorSensors,drawInterstellarMapOverlay,handleMapOverlayLegendClick,getOpenContracts,getContractTargetIndex,chartSystemLabel,acceptCampaignMission,getStarChartSystemScreen,getStarChartPanelRect,starChartHailEdge,updateSecurityOrderPanel,focusStarChartOnSystem,missionObjective,recoveryYardSystems,startDesignRecovery,advanceRecoveryMissions,isModalDialogOpen,renderFleetManager';
